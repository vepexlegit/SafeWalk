package de.vepexlegit.safewalk.mixin.mixins;

import de.vepexlegit.safewalk.*;
...
public abstract class MixinEntity {
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        if (this.noClip) {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = SafeWalk.safewalk ? this.onGround && entity instanceof EntityPlayer : this.onGround && this.isSneaking() && entity instanceof EntityPlayer;
            if (flag) {
                double d6;
